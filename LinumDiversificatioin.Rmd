...
states <- as.character(mydata2$Area)
names(states) <- mydata2$Species

setdiff(phy$tip.label, names(states))
setdiff(names(states),phy$tip.label)

p <- starting.point.geosse(phy)
p

lik1 <- make.geosse(phy, states)
